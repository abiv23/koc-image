...
import { ArrowLeft, Download, Save, Camera, Share, Trash, Maximize, Minimize, X, AlertTriangle } from 'lucide-react';
...
const PhotoDetail = ({ params }) => {
  ...
  const handleDownload = () => {
    // In a real implementation, we would call an API endpoint to resize the image
    // For now, we'll just simulate a download of the original image
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden">
            ...
            <div className="p-6 border-b border-gray-200">
              ...
              <div className="flex flex-wrap items-center text-sm text-gray-500">
                ...
                <span>Original size: {photo.width}x{photo.height}</span>
                <span className="mx-2">•</span>
                <span>File size: {Math.round(photo.size / 1024)} KB</span>
              </div>
            </div>
                ...
                >
                  <div className="relative" style={{ 
                    ...
                    <Image
                      ...
                      width={previewMode === 'resized' ? resizeOptions.width : photo.width}
                      height={previewMode === 'resized' ? resizeOptions.height : photo.height}
